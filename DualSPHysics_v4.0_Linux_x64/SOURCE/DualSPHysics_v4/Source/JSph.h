...
protected:
  ...
  StCubicCte CubicCte;        //-Constante para kernel cubic spline.                                            ///<Constants for Cubic Spline Kernel.
  ...
  TpShifting TShifting; ///<Type of Shifting: None, NoBound, NoFixed, Full.                                      ///<Shifting type: None, NoBound, NoFixed, Full. 
